...
export function AboutPage() {
  return (
    <div className="min-h-screen bg-background pt-24 pb-12">
      ...
      {/* Core Values */}
      <section className="bg-blue-50 dark:bg-blue-950/30 py-16 mb-16">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-card p-8 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">🌟</div>
              <h3 className="text-2xl font-bold text-foreground mb-3">Innovation</h3>
              <p className="text-muted-foreground">
          ...
          <div className="space-y-8">
            <div className="flex gap-6">
              ...
              <div className="flex-1 pb-8">
                <h3 className="text-xl font-bold text-foreground mb-2">Project Initiation</h3>
                <p className="text-muted-foreground">
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-shrink-0 w-1 bg-blue-600 rounded-full"></div>
              <div className="flex-1 pb-8">
                <h3 className="text-xl font-bold text-foreground mb-2">Planning & Design</h3>
                <p className="text-muted-foreground">
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-foreground mb-2">Monitoring & Expansion</h3>
                <p className="text-muted-foreground">
