...
const nodes: TreeNode[] = [
  ...
  { id: 'OC', title: 'OBJETIVO CENTRAL', desc: 'Implementar el subproceso formal de gestión de incidencias TI (PS05.03) con marco ITIL 4 y herramienta GLPI en el Hospital de Emergencias de Villa El Salvador, logrando que el 95% de los incidentes TI se registren y resuelvan a través de GLPI en un plazo de 6 meses.', row: 3, level: 'objetivo-central' },
  { id: 'MD1', title: 'Medio Directo 1', desc: 'Formalizar y aprobar el documento del subproceso PS05.03 e integrarlo al Mapa de Procesos HEVES 2025 bajo el marco ITIL 4, con aprobación formal de la Dirección dentro de los primeros 2 meses del proyecto.', row: 4, level: 'medio-directo' },
  ...
  { id: 'MD3', title: 'Medio Directo 3', desc: 'Capacitar al 100% del personal de la UTI del HEVES en el marco ITIL 4 y en el uso del subproceso PS05.03, con una nota mínima de aprobación del 80% en la evaluación post-capacitación, dentro de los primeros 3 meses.', row: 4, level: 'medio-directo' },
